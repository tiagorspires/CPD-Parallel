...
void OnMult(int m_ar, int m_br, int EventSet) 
{
...
void OnMultLine(int m_ar, int m_br, int EventSet)
{
    SYSTEMTIME Time1, Time2;
	long long values[2];
...
void OnMultBlock(int m_ar, int m_br, int bkSize, int EventSet)
{
    SYSTEMTIME Time1, Time2;
	long long values[2];
...
void OnMultLine_Parallel1(int m_ar, int m_br, int EventSet){
...
void OnMultLine_Parallel2(int m_ar, int m_br, int EventSet){
	...
	do {
		...
		switch (op){
			...
			case 3:
				...
				break;
			case 4:
				OnMultLine_Parallel1(lin, col, EventSet);
				break;
			case 5:	
				OnMultLine_Parallel2(lin, col, EventSet);
				break;
		}
